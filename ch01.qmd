...
> **Note**
>
> If you want a deeper understanding of how ggplot2 works, see Appendix @sec-chapter-ggplot2, which explains the concepts behind ggplot2.
...
If you haven't used the tidyverse before, there is one recipe in particular that you should read that will help you understand a foreign-looking bit of syntax: `%>%`, also known as the pipe operator. This is Recipe @sec-recipe-r-basics-pipe in this chapter.
...
## Chaining Functions Together With `%>%`, the Pipe Operator {#sec-recipe-r-basics-pipe}
...
For many more examples of how to use `%>%` in data manipulation, see Chapter @sec-chapter-dataprep.
